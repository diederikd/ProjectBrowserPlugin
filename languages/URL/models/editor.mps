...
<model ref="r:bc138c2d-7a7c-4478-8987-ef56e424715e(URL.editor)">
  ...
  <node concept="24kQdi" id="3SROZMUwUlo">
    ...
    <node concept="3EZMnI" id="3SROZMUwUlq" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="6WNyGptOtap" role="3EZMnx">
        <property role="3F0ifm" value=".." />
        <ref role="1ERwB7" node="6WNyGptOvDh" resolve="OpenBrowser" />
      </node>
    </node>
  </node>
  ...
  <node concept="1h_SRR" id="6WNyGptOvDh">
    <property role="TrG5h" value="OpenBrowser" />
    <ref role="1h_SK9" to="gwk3:3SROZMUwUkX" resolve="URL" />
    <node concept="1hA7zw" id="6WNyGptOvDi" role="1h_SK8">
      <property role="1hAc7j" value="click_action_id" />
      <property role="1hHO97" value="Open browser" />
      <node concept="1hAIg9" id="6WNyGptOvDj" role="1hA7z_">
        <node concept="3clFbS" id="6WNyGptOvDk" role="2VODD2">
          <node concept="3cpWs8" id="6WNyGptOIs3" role="3cqZAp">
            <node concept="3cpWsn" id="6WNyGptOIs1" role="3cpWs9">
              <property role="TrG5h" value="browserPlugin" />
              <node concept="3uibUv" id="6WNyGptOIvf" role="1tU5fm">
                <ref role="3uigEE" to="4gmt:1n9jAIspa_5" resolve="BrowserPlugin" />
              </node>
              <node concept="2ShNRf" id="6WNyGptOIvZ" role="33vP2m">
                <node concept="1pGfFk" id="6WNyGptOIvX" role="2ShVmc">
                  <ref role="37wK5l" to="4gmt:1n9jAIspP95" resolve="BrowserPlugin" />
                </node>
              </node>
            </node>
          </node>
          <node concept="3clFbF" id="14CE$uvwtDc" role="3cqZAp">
            <node concept="2OqwBi" id="14CE$uvwtZX" role="3clFbG">
              <node concept="10M0yZ" id="14CE$uvwtDT" role="2Oq$k0">
                <ref role="3cqZAo" to="wyt6:~System.out" resolve="out" />
                <ref role="1PxDUh" to="wyt6:~System" resolve="System" />
              </node>
              <node concept="liA8E" id="14CE$uvwuvP" role="2OqNvi">
                <ref role="37wK5l" to="guwi:~PrintStream.println(java.lang.String):void" resolve="println" />
                <node concept="3cpWs3" id="14CE$uvwvaH" role="37wK5m">
                  <node concept="2OqwBi" id="14CE$uvwvpD" role="3uHU7w">
                    <node concept="0IXxy" id="14CE$uvwvd0" role="2Oq$k0" />
                    <node concept="3TrcHB" id="14CE$uvwvDu" role="2OqNvi">
                      <ref role="3TsBF5" to="gwk3:tBGstjpPhD" resolve="url" />
                    </node>
                  </node>
                  <node concept="Xl_RD" id="14CE$uvwuwo" role="3uHU7B">
                    <property role="Xl_RC" value="Call load url " />
                  </node>
                </node>
              </node>
            </node>
          </node>
          <node concept="3clFbF" id="14CE$uvvYcK" role="3cqZAp">
            <node concept="2OqwBi" id="14CE$uvvYip" role="3clFbG">
              <node concept="37vLTw" id="14CE$uvvYcI" role="2Oq$k0">
                <ref role="3cqZAo" node="6WNyGptOIs1" resolve="browserPlugin" />
              </node>
              <node concept="liA8E" id="14CE$uvvYqm" role="2OqNvi">
                <ref role="37wK5l" to="4gmt:1n9jAIspAkf" resolve="load" />
                <node concept="0IXxy" id="14CE$uvvYr9" role="37wK5m" />
              </node>
            </node>
          </node>
        </node>
